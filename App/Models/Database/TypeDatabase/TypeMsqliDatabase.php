...
class TypeMsqliDatabase implements InterfaceTypeDatabase
{
    private $mysqli;
    ...
    {
        $this->mysqli = new Connection(new ConnectMysqliDatabase);
        
        $this->objectMysqli = $this->mysqli->connectDatabase();
    }
    public function prepare($sql)
    {
        $this->objectMysqli = $this->objectMysqli->prepare($sql);
    }
